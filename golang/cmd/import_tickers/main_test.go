...
func Test_getProdConfig(t *testing.T) {
	...
	if cfg.ServerURL.DRFServer != "http://localhost:7000" {
		t.Errorf("Expected DRFServer to be 'http://localhost:7000', got '%s'", cfg.ServerURL.DRFServer)
	}
}
...
func Test_getLocalConfig(t *testing.T) {
	...
	if cfg.ServerURL.DRFServer != "http://localhost:8000" {
		t.Errorf("Expected DRFServer to be 'http://localhost:8000', got '%s'", cfg.ServerURL.DRFServer)
	}
}
